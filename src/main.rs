...
fn main() {
    ...
    let input2 = "737	1866	1565	1452	1908	1874	232	1928	201	241	922	281	1651	1740	1012	1001
        ...
        ";
    let input3 = 361527;
    let input4 = "pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk
    ...
    let input5 = "1
        ...
        -705
        ";
    let input6 = "11	11	13	7	0	15	5	5	4	4	1	1	7	1	15	11";
    let input7 = "";
    let input8 = "";
    let input9 = "";
    let input10 = "";
    ...
    // println!("day 7: part 1: {}, part 2: {}", day7_1(input7), day7_2(input7));
    // println!("day 8: part 1: {}, part 2: {}", day8_1(input8), day8_2(input8));
    // println!("day 9: part 1: {}, part 2: {}", day9_1(input9), day9_2(input9));
    // println!("day 10: part 1: {}, part 2: {}", day10_1(input10), day10_2(input10));
}
